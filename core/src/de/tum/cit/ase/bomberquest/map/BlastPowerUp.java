...
/**
 * This class is used to implement a BlastPowerUp. By collecting BlastPowerUp, the max range of the bombs gets increased.
 */
public class BlastPowerUp implements Drawable {
     ...
     */
    public BlastPowerUp(World world, float x, float y) {
        this.x = x;
        this.y = y;
        createHitbox(world);
