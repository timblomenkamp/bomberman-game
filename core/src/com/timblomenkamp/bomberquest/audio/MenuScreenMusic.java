package com.timblomenkamp.bomberquest.audio;
 ...
 */
public enum MenuScreenMusic {

    MENUSCREEN("MenuScreen.mp3", 0.25f);

    /** The music file owned by this variant. */
    private final Music music;

    MenuScreenMusic(String fileName, float volume) {
    ...
    public void pause(){this.music.pause();}
}
