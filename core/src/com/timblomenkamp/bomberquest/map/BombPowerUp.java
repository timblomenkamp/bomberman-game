...
/**
 * This class is used to implement a BombPowerUp. By collecting BombPowerUps, the max number of bombs the users can place gets increased.
 */
public class BombPowerUp implements Drawable {
    ...
    /**
     * BombPowerUp constructor
     */
    public BombPowerUp(World world, float x, float y) {
        this.x = x;
        this.y = y;
        createHitbox(world);
    }
    ...
    /**
     * Create a Box2D body for the BombPowerUp.
